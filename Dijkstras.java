...
public class Dijkstras {
	private HashMap<String, Integer> StopIDs = new HashMap<String, Integer>();
	...
	public Dijkstras() {
		...
		String name = "transfers.txt";
		runShortestPath(name);
		//s.close();
	}
	
	private void stopIDMap() {
